...
"""
Post-processing program to generate images between two random samples (interpolation) from the trained model of the final version of DCGAN (DCGAN 3)

Requirements
----------
model.ckpt : file containing the model weights (output of the training program)
../random_uni_256.npy : file containing two 256-long random samples from a uniform distribution
...
random = np.load("../random_uni_256.npy")
