...
"""
Post-processing program to generate images between two random samples (interpolation) from the trained model of the final version of ProGAN (ProGAN 5)

Requirements
----------
model.ckpt : file containing the model weights (output of the training program)
../random_gauss_512.npy : file containing two 512-long random samples from a gaussian distribution
...
random = np.load("../random_gauss_512.npy")
